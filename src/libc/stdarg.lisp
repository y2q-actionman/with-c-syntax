...
(eval-when (:load-toplevel :execute)
  ...
  (define-preprocessor-macro-with-upcase "va_start" #'va_start)
  (define-preprocessor-macro-with-upcase "va_arg" #'va_arg)
  (define-preprocessor-macro-with-upcase "va_end" #'va_end)
  (define-preprocessor-macro-with-upcase "va_copy" #'va_copy)
  )
