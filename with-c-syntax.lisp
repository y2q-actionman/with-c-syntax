       ...
       (ecase storage-class
         ...
         (|global|
          ...
          (append-item-to-right-f lexical-binds
                                  `(,name (if (boundp ',name) (symbol-value ',name) ,init)))
          (append-item-to-right-f global-defs
                                  `(defvar ,name ,name "generated by with-c-syntax, for global")))
         ;; 'static' vars.
         (|static|
          (let ((st-sym (gensym (format nil "static-var-~S-" name))))
            (append-item-to-right-f lexical-binds
                                    `(,name (if (boundp ',st-sym) (symbol-value ',st-sym) ,init)))
            (append-item-to-right-f global-defs
                                    `(defvar ,st-sym ,name "generated by with-c-syntax, for static"))
            ))
         ;; 'typedef' vars
         (|typedef|
