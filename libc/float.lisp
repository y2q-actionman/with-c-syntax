...
;; single-float
(define-preprocessor-symbol FLT_RADIX
  (float-radix 1f0))

(define-preprocessor-symbol FLT_MANT_DIG
  (float-digits 1f0))

(define-preprocessor-symbol FLT_EPSILON
  single-float-epsilon)

(define-preprocessor-symbol FLT_DIG
  (mantissa-radix-change
     FLT_MANT_DIG FLT_RADIX 10))

(define-preprocessor-symbol FLT_MIN_EXP
  (nth-value 1 (decode-float least-positive-normalized-single-float)))

(define-preprocessor-symbol FLT_MIN
  least-positive-normalized-single-float)

(define-preprocessor-symbol FLT_MIN_10_EXP
  (ceiling (log least-positive-normalized-single-float 10)))
  
(define-preprocessor-symbol FLT_MAX_EXP
  (nth-value 1 (decode-float most-positive-single-float)))

(define-preprocessor-symbol FLT_MAX
  most-positive-single-float)

(define-preprocessor-symbol FLT_MAX_10_EXP
  (floor (log most-positive-single-float 10)))

;; double-float
(define-preprocessor-symbol DBL_RADIX	; extension
  (float-radix 1d0))

(define-preprocessor-symbol DBL_MANT_DIG
  (float-digits 1d0))

(define-preprocessor-symbol DBL_EPSILON
  double-float-epsilon)

(define-preprocessor-symbol DBL_DIG
  (mantissa-radix-change DBL_MANT_DIG DBL_RADIX 10))

(define-preprocessor-symbol DBL_MIN_EXP
  (nth-value 1 (decode-float least-positive-normalized-double-float)))

(define-preprocessor-symbol DBL_MIN
  least-positive-normalized-double-float)

(define-preprocessor-symbol DBL_MIN_10_EXP
  (ceiling (log least-positive-normalized-double-float 10)))
  
(define-preprocessor-symbol DBL_MAX_EXP
  (nth-value 1 (decode-float most-positive-double-float)))

(define-preprocessor-symbol DBL_MAX
  most-positive-double-float)

(define-preprocessor-symbol DBL_MAX_10_EXP
  (floor (log most-positive-double-float 10)))

;; long-float
(define-preprocessor-symbol LDBL_RADIX	; extension
  (float-radix 1l0))

(define-preprocessor-symbol LDBL_MANT_DIG
  (float-digits 1l0))

(define-preprocessor-symbol LDBL_EPSILON
  long-float-epsilon)

(define-preprocessor-symbol LDBL_DIG
  (mantissa-radix-change LDBL_MANT_DIG LDBL_RADIX 10))

(define-preprocessor-symbol LDBL_MIN_EXP
  (nth-value 1 (decode-float least-positive-normalized-long-float)))

(define-preprocessor-symbol LDBL_MIN
  least-positive-normalized-long-float)

(define-preprocessor-symbol LDBL_MIN_10_EXP
  (ceiling (log least-positive-normalized-long-float 10)))
  
(define-preprocessor-symbol LDBL_MAX_EXP
  (nth-value 1 (decode-float most-positive-long-float)))

(define-preprocessor-symbol LDBL_MAX
  most-positive-long-float)

(define-preprocessor-symbol LDBL_MAX_10_EXP
  (floor (log most-positive-long-float 10)))

;; short-float ; extension
(define-preprocessor-symbol SFLT_RADIX
  (float-radix 1s0))

(define-preprocessor-symbol SFLT_MANT_DIG
  (float-digits 1s0))

(define-preprocessor-symbol SFLT_EPSILON
  short-float-epsilon)

(define-preprocessor-symbol SFLT_DIG
  (mantissa-radix-change SFLT_MANT_DIG SFLT_RADIX 10))

(define-preprocessor-symbol SFLT_MIN_EXP
  (nth-value 1 (decode-float least-positive-normalized-short-float)))

(define-preprocessor-symbol SFLT_MIN
  least-positive-normalized-short-float)

(define-preprocessor-symbol SFLT_MIN_10_EXP
  (ceiling (log least-positive-normalized-short-float 10)))
  
(define-preprocessor-symbol SFLT_MAX_EXP
  (nth-value 1 (decode-float most-positive-short-float)))

(define-preprocessor-symbol SFLT_MAX
  most-positive-short-float)

(define-preprocessor-symbol SFLT_MAX_10_EXP
...
(define-preprocessor-symbol FLT_ROUNDS
  -1)

;; C99
(define-preprocessor-symbol DECIMAL_DIG
...
(define-preprocessor-symbol FLT_EVAL_METHOD
  -1)
